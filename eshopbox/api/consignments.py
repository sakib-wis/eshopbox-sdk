...
class ConsigmentsAPI(BaseAPI):
    ...
    def get_all(self, page: int = 1, **filters) -> Dict:
        ...
        """
        url = f"{self.base_url}/api/v1/consigments/erp"
    ...
    def create(self, order_data: Dict) -> Dict:
        ...
        Example:
            ...
            ...     "shippingAddress": {...}
            ... }
            >>> result = api.consigments.create(order)
        """
